    ...
    _KnowledgeGroup(
      ...
      items: <_KnowledgeItem>[
        _KnowledgeItem(
          ...
          'Напоминание',
          'Локальное уведомление, которое создается для задачи при включенных уведомлениях.',
        ),
        _KnowledgeItem(
          Icons.repeat_rounded,
          'Повтор',
          'Ежедневные, еженедельные, месячные и пользовательские повторяющиеся задачи.',
        ),
        _KnowledgeItem(
          Icons.bolt_rounded,
          'Текущие',
